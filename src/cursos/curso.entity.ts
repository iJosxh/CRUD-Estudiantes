...
export class Curso{
    ...
    @ManyToOne(() => CatalogoDetalleEntity, (catalogoDetalle) => catalogoDetalle.cursosPorNivel,)
    @JoinColumn({name: 'idNivel'})
    nivel: Relation<CatalogoDetalle>;

    @ManyToOne(() => CatalogoDetalleEntity, (catalogoDetalle) => catalogoDetalle.cursosPorGrado,)
    @JoinColumn({name: 'idGrado'})
    grado: Relation<CatalogoDetalle>;

    @ManyToOne(() => CatalogoDetalleEntity, (catalogoDetalle) => catalogoDetalle.cursosPorCarrera,)
    @JoinColumn({name: 'idCarrera'})
    carrera: Relation<CatalogoDetalle>;

    @ManyToOne(() => CatalogoDetalleEntity, (catalogoDetalle) => catalogoDetalle.cursosPorEstado,)
    @JoinColumn({name: 'idEstado'})
    estado: Relation<CatalogoDetalle>;

    @ManyToOne(() => Catedratico, (catedratico) => catedratico.cursos,)
    @JoinColumn({name: 'idCatedratico'})
    catedratico: Catedratico

    @OneToMany(() => CursoAsignado, (cursoAsignado) => cursoAsignado.curso,)
